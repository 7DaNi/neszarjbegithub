...
?>
<h2>Törölt vagy hibás rendelések</h2>
<div id="lista">
...
<tr bgcolor="#E0FFFF">
	...
	$query = "SELECT * FROM rendelesek_hibas WHERE rendelesid LIKE '%" . $feltetel . "%' OR userid LIKE '%" . $feltetel . "%' OR nev LIKE  '%" . $feltetel . "%' OR megjegyzes LIKE  '%" . $feltetel . "%' OR datum LIKE  '%" . $feltetel . "%' OR allapot LIKE  '%" . $feltetel . "%'";
...
<tr bgcolor="#E0FFFF">
	...
	$query = "SELECT * FROM rendelesek_hibas";
