...
<tr bgcolor="#E0FFFF">
	...
	$query = "SELECT * FROM termekek WHERE kategoria='üdítők' AND etelnev LIKE '%" . $feltetel . "%' OR leiras LIKE '%" . $feltetel . "%' OR kep LIKE  '%" . $feltetel . "%'";
...
<tr bgcolor="#E0FFFF">
	...
	$query = "SELECT * FROM termekek WHERE kategoria='üdítők'";
